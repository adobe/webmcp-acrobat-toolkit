# Screenshots / media for the README

Drop these files here and the top‑level `README.md` will pick them up automatically:
...
Tips: crop to the interesting area, use a clean sample doc, and keep file sizes reasonable so the README loads fast on GitHub.
